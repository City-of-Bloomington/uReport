<?php
/**
 * A collection class for NeighborhoodAssociation objects
 *
 ...
 * each NeighborhoodAssociation object
 *
 ...
 */
class NeighborhoodAssociationList extends ZendDbResultIterator
{
	/**
	...
	{
		$this->select->from('neighborhoodAssociations');

		// Finding on fields from the neighborhoodAssociations table is handled here
		if (count($fields)) {
		...
		// above foreach only handles fields from the neighborhoodAssociations table.
	...
	/**
	 * Hydrates all the NeighborhoodAssociation objects from a database result set
	 *
	 * This is a callback function, called from ZendDbResultIterator.  It is
	 * called once per row of the result.
	 *
	 * @param int $key The index of the result row to load
	 * @return NeighborhoodAssociation
	 */
	protected function loadResult($key)
	{
		return new NeighborhoodAssociation($this->result[$key]);
	}
}
