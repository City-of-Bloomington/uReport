<?php
/**
 * A collection class for IssueType objects
 *
...
class IssueTypeList extends ZendDbResultIterator
{
	...
	public function find($fields=null,$order='id',$limit=null,$groupBy=null)
	{
		...
		// Finding on fields from the issueTypes table is handled here
		if (count($fields)) {
		...
		// above foreach only handles fields from the issueTypes table.
	...
	/**
	 * Hydrates all the IssueType objects from a database result set
	 *
