<?php
/**
 * A collection class for Media objects
 *
...
{
	private $columns = array('id','filename','mime_type','media_type',,'person_id');
	 ...
	 */
	public function find($fields=null,$order='title',$limit=null,$groupBy=null)
	{
		$this->select->from('media');

		// Finding on fields from the media table is handled here
		if (count($fields)) {
		...
		// above foreach only handles fields from the media table.
	...
	/**
	 * Hydrates all the Media objects from a database result set
	 *
