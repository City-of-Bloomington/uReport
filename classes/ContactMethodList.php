<?php
/**
 * A collection class for Contactmethod objects
 *
...
class ContactMethodList extends ZendDbResultIterator
{
	...
	public function find($fields=null,$order='id',$limit=null,$groupBy=null)
	{
		...
		// Finding on fields from the contactmethods table is handled here
		if (count($fields)) {
		...
		// above foreach only handles fields from the contactmethods table.
	...
	/**
	 * Hydrates all the Contactmethod objects from a database result set
	 *
